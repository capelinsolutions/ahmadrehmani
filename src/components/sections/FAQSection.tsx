...
const faqs = [
  ...
  { q: "What conditions does Dr. Rehmani treat?", a: "Dr. Rehmani specializes exclusively in diseases of the retina and vitreous, including age-related macular degeneration (AMD), diabetic retinopathy, retinal detachment, retinal tears, vitreous hemorrhage, posterior vitreous detachment (PVD), and macular holes. He also performs comprehensive retinal imaging and offers specialist second opinions. Please see “conditions” above for a full comprehensive list." },
  { q: "What insurance does Dr. Rehmani accept?", a: "We currently accept Aetna, Blue Cross Blue Shield, Community Health Choice, Cigna, CHC Marketplace, Employers Health Network, Multiplan (PHCS network), United Healthcare, and Wellpoint. We are actively credentialing with Medicare, Medicare Advantage, and the MHMD network and expect to be in-network within the next 3 months. Please call (346) 587-0223 to verify your specific plan." },
  ...
  { q: "Are anti-VEGF retinal injections painful?", a: "Anti-VEGF injections (except Eylea, Vabysmo, Lucentis, Avastin) are performed with numbing drops that minimize discomfort. Most patients report feeling only light pressure for a few seconds. The procedure takes just a few minutes in the office, and patients typically return to normal activities the same day." },
